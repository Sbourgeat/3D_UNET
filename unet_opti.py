...
def parse_arguments():
    ...
    parser.add_argument(
        "--downsampling_factor", type=int, default=6, help="Downsampling factor"
    )
    parser.add_argument(
        "--dropout", type=float, default=0.38702234285347614, help="Dropout rate"
    )
    parser.add_argument(
        "--learning_rate",
        type=float,
        default=0.0003960879859805342,
        help="Learning rate",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--lr_scheduler", type=str, default="none", help="Learning rate scheduler"
    )
    parser.add_argument("--num_epochs", type=int, default=1000, help="Number of epochs")
    parser.add_argument("--optimizer", type=str, default="adam", help="Optimizer")
    parser.add_argument("--target_shape", type=int, default=192, help="Target shape")
...
class CustomDataset(Dataset):
    def __init__(
        ...
        self.target_images = self.target_images.permute(0, 4, 2, 3, 1)
